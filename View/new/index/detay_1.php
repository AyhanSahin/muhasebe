                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="block-breadcrumb">
                                <ul class="breadcrumb">
                                    <li><a href="<?php SELF::go(""); ?>" class="breadcrump-link"><?php echo $lang->anasayfa; ?></a></li>
                                     <?php
     $ki = 0;
...
<?php  $rsm = $api::resim($ilan->id);  
   ...
   <?php $cpn = $api::saticiadi($ilan->user_id); if($cpn) { ?>                                     
...
<?php $tekfirsat = $api::firsatnewtek();  if($tekfirsat){  ?>
...
function xxx(id){
  ...
  $("#product-zoom").attr("src",thmp).attr("data-zoom-image",resim); 
     ...
     for (i = 1; i <= sss[id].stok; i++) { $("#quantitySelect").append("<option>" + i + "</option>");}  
