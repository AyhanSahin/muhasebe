                        ...
                        <!-- BEGIN PAGE TITLE -->
                             <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    / <a href="<?php SELF::go("musteri/musteri_listesi");?>"><span class="caption-helper">MÜŞTERİ LİSTESİ</span></a> / <span class="caption-helper">MÜŞTERİ KAYDET</span>
                                                </div>
...
<div class="portlet light bg-inverse form-fit">
                                                ...
                                                <form action="<?php SELF::go("musteri/musteri_ekle");?>" method="post" class="form-horizontal form-row-seperated">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" placeholder="FİRMA UNVANI" name="unvan" class="form-control" required>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" placeholder="KISA İSİM" name="kisa_ad" class="form-control input-medium">
                                        ...
                                        <!-- /.modal-dialog -->
                                                         ...
                                                         <option value="<?php echo $fl_id_ad->id; ?>"><?php echo $fl_id_ad->ad; ?></option>
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" placeholder="E-POSTA ADRESİ" class="form-control"  name="eposta">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" placeholder="TELEFON NUMARASI" class="form-control"  name="telefon">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" placeholder="FAKS NUMARASI" class="form-control"  name="fax"> 
                                                            ...
                                                            <div class="col-md-9">
                                                                ...
                                                                <input type="text" placeholder="IBAN NUMARASI" name="iban_1" class="form-control input-medium">
                                                                    <span>  <hr> </span>  
                                                            ...
                                                            <div class="col-md-9">
                                                                ...
                                                                <span class="help-block"><label class="container">Adres Yurt dışında <input name="adres_yd" value="2" onchange="bak()" type="checkbox" >
                                                 ...
                                                 <div class="form-group il_ilce">
                                                    ...
                                                    <div class="col-md-3"></div>
                                                            ...
                                                            <div class="col-md-9">
                                                                 ...
                                                                 <span class="help-block"><label class="container">Tüzel Kişi <input name="turu" value="TK" onchange="xbak('t')" type="radio" checked="checked"  >
                                                                <span class="checkmark"></span>
                                                              </label>  <label class="container">Gerçek Kişi <input name="turu" onchange="xbak('g')" value="GK"   type="radio" >
                                                                <span class="checkmark"></span>
                                                              </label> </span>
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                               <span class="text"> Alış. </span> <input type="radio" name="doviz_a_s" value="a" class="icheck" checked></input>
                                                                <span class="text-left"> Satış. </span><input type="radio" name="doviz_a_s" value="s" class="icheck" ></input>
                                                      ...
                                                      <label class="control-label col-md-3">AÇILIŞ BAKİYESİ</label>                
                                                         <div class="col-md-6">     <span class="help-block"><label class="container">Açılış bakiyesi var <input name="acilisbakiyesivarmi" value="1" onchange="abak()" type="checkbox" >
                                                                <span class="checkmark"></span>
                                                              </label> </span></div>                
                                                        <div class="col-md-3">  </div> 
                                                        </div> 
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
                                                        <input type="text" value="<?php echo date('d-m-Y') ?>" class="form-control input-small" readonly name="acilis_bakiyesi_tarih">
                                            ...
                                            <input type="text" data-type='currency' name="acilis_bakiyesi" value="" class="form-control"  placeholder="1.000">
